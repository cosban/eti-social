...
n.on("users",function(e){o.friends=e.friends,o.requests=e.requests,o.requested=e.requested,o.users=e.inTopic,r.resolve(o)}),n.on("friendRequest",function(e){o.requests.push(e),s(o)}),n.on("friendJoined",function(e){o.friends.push(e),s(o)}),n.on("friendLeft",function(i){e(o.friends,i,!0),s(o)}),n.on("joined",function(e){o.users.push(e),s(o)}),n.on("left",function(i){e(o.users,i,!0),s(o)})
var l=[]
