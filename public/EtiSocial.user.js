...
l.topic=null,l.showFriends=JSON.parse(localStorage.getItem("eti-social-showFriends"))||!1,l.toggleShowFriends=s,l.request=o,l.respond=r,t.getInfo().then(function(e){l.topic=e}),t.onUpdate(function(e){l.topic=e,n.$apply()})}]}}]).factory("Topic",["$q",function(n){function t(n){var i=n.friend||e(r.friends,n),t=(e(r.requests,n)||e(r.requested,n))&&!i
return{name:n.name,friend:i,pending:t}}function s(e){u.push(e)}function o(e){r.users=r.users.map(t),u.forEach(function(n){n(e)})}var r={users:null,friends:null,requests:null,requested:null},l=n.defer()
i.on("users",function(e){r.friends=e.friends,r.requests=e.requests,r.requested=e.requested,r.users=e.inTopic.map(t),l.resolve(r)}),i.on("friendRequest",function(e){r.requests.push(e),o(r)}),i.on("friendJoined",function(e){r.friends.push(e),o(r)}),i.on("friendLeft",function(n){e(r.friends,n,!0),o(r)}),i.on("joined",function(e){r.users.push(e),o(r)}),i.on("left",function(n){e(r.users,n,!0),o(r)})
var u=[]
return{getInfo:function(){return l.promise},onUpdate:s,notify:o}}]),t.innerHTML="<eti-social></eti-social>",document.body.appendChild(t),angular.bootstrap(t,["eti.social"])}()
